  ...
  Future<void> _checkAdminStatus() async {
    ...
    try {
      ...
      final response = await request.get(
          'https://ainur-fadhil-sportpedia.pbp.cs.ui.ac.id/accounts/api/user-info/');
                          ...
                          return Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Search for videos, sports, or instructors...',
                                hintStyle: TextStyle(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: _buildDropdownFilter(
                                      label: (_tempSportId ??
                                              ...
                                              null
                                          ? 'All Sports'
                                          : _sports.firstWhere((s) =>
                                                  s['id'] ==
                                                  (_tempSportId ??
                                                      _selectedSportId))['name']
                                              as String,
                                  ...
                                  Expanded(
                                    child: _buildDropdownFilter(
                                      label: (_tempDifficulty ??
                                                  _selectedDifficulty) ==
                                              null
                                          ? 'Difficulty Level'
                                          : _difficulties.firstWhere((d) =>
                                                  d['value'] ==
                                                  (_tempDifficulty ??
                                                      _selectedDifficulty))[
                                              'label'] as String,
              ...
              child: ListView(
                ...
                children: _sports
                    .map((sport) => ListTile(
                          ...
                          selected:
                              (_tempSportId ?? _selectedSportId) == sport['id'],
                          onTap: () {
                            setState(() {
              ...
              child: ListView(
                ...
                children: _difficulties
                    .map((diff) => ListTile(
                          ...
                          selected: (_tempDifficulty ?? _selectedDifficulty) ==
                              diff['value'],
                          onTap: () {
                            setState(() {
        ...
        child: Column(
          ...
          children: [
            ...
            Flexible(
              child: ListView(
                shrinkWrap: true,
                children: ['popular', 'newest', 'rating', 'views']
                    .map((sort) => ListTile(
                          title: Text(
                            sort == 'popular'
                                ? 'Most Popular'
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: _getDifficultyGradient(video.difficulty)
                                  .colors
                                  .first
                                  .withOpacity(0.4),
                              blurRadius: 4,
...
class _Animated3DCardStateful extends StatefulWidget {
  ...
  @override
  State<_Animated3DCardStateful> createState() =>
      _Animated3DCardStatefulState();
}
                ...
                boxShadow: [
                  ...
                  BoxShadow(
                    color: widget.primaryBlue
                        .withOpacity(0.15 * _elevationAnimation.value),
                  ...
                  BoxShadow(
                    color: Colors.black
                        .withOpacity(0.12 * _elevationAnimation.value),
